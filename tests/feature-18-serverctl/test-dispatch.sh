...
#
# Scenario: serverctl dispatch — unknown subcommand/target exit 2 + usage; `all` expands to proxy+server.
#
...
# serverctl exposes an exec-capture hook: when DS4CTL_TRACE points at a file, each
