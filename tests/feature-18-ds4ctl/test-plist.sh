#!/usr/bin/env bash
# Tests: scripts/ds4ctl.sh, scripts/lib/launchd.sh, scripts/lib/paths.sh
# Tags: lifecycle, ds4ctl, scope:issue-specific
#
# Scenario: ds4ctl launchd plist — Label, KeepAlive=true, RunAtLoad=true, ProgramArguments, StandardOutPath present; reinstall overwrites without duplicating.
#
